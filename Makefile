...
prefix = /home/dianyu/dujuan/local
exec_prefix = ${prefix}
...
TOPLEVEL_CONFIGURE_ARGUMENTS=./configure --prefix=/home/dianyu/dujuan/local CC=aarch64-buildroot-linux-gnu-gcc --target=aarch64-buildroot-linux-gnu --build=x86_64-linux-gnu --host=aarch64-buildroot-linux-gnu

tooldir = ${exec_prefix}/aarch64-buildroot-linux-gnu
build_tooldir = ${exec_prefix}/aarch64-buildroot-linux-gnu
...
BUILD_CONFIGARGS =  --cache-file=./config.cache '--prefix=/home/dianyu/dujuan/local' --program-transform-name='s,y,y,' --disable-option-checking --with-build-subdir="$(BUILD_SUBDIR)"
...
HOST_CONFIGARGS =  --cache-file=./config.cache  '--prefix=/home/dianyu/dujuan/local' --program-transform-name='s,y,y,' --disable-option-checking
...
TARGET_SUBDIR = aarch64-buildroot-linux-gnu
# This is set by the configure script to the arguments to use when configuring
# directories built for the target.
TARGET_CONFIGARGS = --cache-file=./config.cache --enable-multilib   '--prefix=/home/dianyu/dujuan/local' --program-transform-name='s,y,y,' --disable-option-checking --with-target-subdir="$(TARGET_SUBDIR)"
# This is the list of variables to export in the environment when
...
DLLTOOL = aarch64-buildroot-linux-gnu-dlltool
LD = /home/dianyu/dujuan/sail_rk356x_linux_release_v1.3.0_20220620/buildroot/output/sail_rk3568/host/lib/gcc/aarch64-buildroot-linux-gnu/10.3.0/../../../../aarch64-buildroot-linux-gnu/bin/ld
LIPO = aarch64-buildroot-linux-gnu-lipo
...
WINDRES = aarch64-buildroot-linux-gnu-windres
WINDMC = aarch64-buildroot-linux-gnu-windmc
...
AR_FOR_TARGET=/home/dianyu/dujuan/sail_rk356x_linux_release_v1.3.0_20220620/buildroot/output/sail_rk3568/host/lib/gcc/aarch64-buildroot-linux-gnu/10.3.0/../../../../aarch64-buildroot-linux-gnu/bin/ar
AS_FOR_TARGET=/home/dianyu/dujuan/sail_rk356x_linux_release_v1.3.0_20220620/buildroot/output/sail_rk3568/host/lib/gcc/aarch64-buildroot-linux-gnu/10.3.0/../../../../aarch64-buildroot-linux-gnu/bin/as
CC_FOR_TARGET=$(STAGE_CC_WRAPPER) aarch64-buildroot-linux-gnu-cc

# If GCC_FOR_TARGET is not overriden on the command line, then this
# variable is passed down to the gcc Makefile, where it is used to
# build libgcc2.a.  We define it here so that it can itself be
# overridden on the command line.
GCC_FOR_TARGET=$(STAGE_CC_WRAPPER) aarch64-buildroot-linux-gnu-gcc
CXX_FOR_TARGET=$(STAGE_CC_WRAPPER) aarch64-buildroot-linux-gnu-c++
RAW_CXX_FOR_TARGET=$(STAGE_CC_WRAPPER) aarch64-buildroot-linux-gnu-c++
GFORTRAN_FOR_TARGET=$(STAGE_CC_WRAPPER) aarch64-buildroot-linux-gnu-gfortran
GOC_FOR_TARGET=$(STAGE_CC_WRAPPER) aarch64-buildroot-linux-gnu-gccgo
DLLTOOL_FOR_TARGET=aarch64-buildroot-linux-gnu-dlltool
LD_FOR_TARGET=/home/dianyu/dujuan/sail_rk356x_linux_release_v1.3.0_20220620/buildroot/output/sail_rk3568/host/lib/gcc/aarch64-buildroot-linux-gnu/10.3.0/../../../../aarch64-buildroot-linux-gnu/bin/ld

LIPO_FOR_TARGET=aarch64-buildroot-linux-gnu-lipo
NM_FOR_TARGET=/home/dianyu/dujuan/sail_rk356x_linux_release_v1.3.0_20220620/buildroot/output/sail_rk3568/host/lib/gcc/aarch64-buildroot-linux-gnu/10.3.0/../../../../aarch64-buildroot-linux-gnu/bin/nm
OBJDUMP_FOR_TARGET=/home/dianyu/dujuan/sail_rk356x_linux_release_v1.3.0_20220620/buildroot/output/sail_rk3568/host/lib/gcc/aarch64-buildroot-linux-gnu/10.3.0/../../../../aarch64-buildroot-linux-gnu/bin/objdump
OBJCOPY_FOR_TARGET=/home/dianyu/dujuan/sail_rk356x_linux_release_v1.3.0_20220620/buildroot/output/sail_rk3568/host/lib/gcc/aarch64-buildroot-linux-gnu/10.3.0/../../../../aarch64-buildroot-linux-gnu/bin/objcopy
RANLIB_FOR_TARGET=/home/dianyu/dujuan/sail_rk356x_linux_release_v1.3.0_20220620/buildroot/output/sail_rk3568/host/lib/gcc/aarch64-buildroot-linux-gnu/10.3.0/../../../../aarch64-buildroot-linux-gnu/bin/ranlib
READELF_FOR_TARGET=/home/dianyu/dujuan/sail_rk356x_linux_release_v1.3.0_20220620/buildroot/output/sail_rk3568/host/lib/gcc/aarch64-buildroot-linux-gnu/10.3.0/../../../../aarch64-buildroot-linux-gnu/bin/readelf
STRIP_FOR_TARGET=/home/dianyu/dujuan/sail_rk356x_linux_release_v1.3.0_20220620/buildroot/output/sail_rk3568/host/lib/gcc/aarch64-buildroot-linux-gnu/10.3.0/../../../../aarch64-buildroot-linux-gnu/bin/strip
WINDRES_FOR_TARGET=aarch64-buildroot-linux-gnu-windres
WINDMC_FOR_TARGET=aarch64-buildroot-linux-gnu-windmc
